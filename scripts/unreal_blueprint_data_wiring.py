...
BLUEPRINT_VARIABLES = {
    ...
    "/Game/Blueprints/BP_MenuFlowController": [
        ...
        ("PrimaryTargetRouteId", STRING, False),
        ("SecondaryTargetRouteId", STRING, False),
        ("BackTargetRouteId", STRING, False),
    ...
    "/Game/UI/WBP_MainPlayerMenu": [
        ...
        ("BreadcrumbText", STRING, False),
        ("RouteSummaryText", STRING, False),
        ("NavSectionTitleText", STRING, False),
        ("OperationTitleText", STRING, False),
        ("OperationZoneCodeText", STRING, False),
        ("ThreatLevelText", STRING, False),
        ("ExtractionWindowsText", STRING, False),
        ("EnvironmentalAnomalyText", STRING, False),
        ("RecommendedTeamSizeText", STRING, False),
        ("BriefObjectiveText", STRING, False),
        ("OperationPrimaryActionSubtext", STRING, False),
        ("OperatorNameText", STRING, False),
        ("OperatorIdText", STRING, False),
        ("FactionDisplayNameText", STRING, False),
        ("FactionRoleText", STRING, False),
        ("HealthConditionText", STRING, False),
        ("ReputationSummaryText", STRING, False),
        ("CurrencySummaryText", STRING, False),
        ("KitSummaryText", STRING, False),
        ("FooterBuildLabelText", STRING, False),
        ("FooterEnvironmentLabelText", STRING, False),
        ("FooterStatusText", STRING, False),
        ("FooterLocalTimeText", STRING, False),
    ],
